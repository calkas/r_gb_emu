...
pub mod arithmetic_logic {
    ...
    static ARITHMETIC_LOGIC_OPCODES:[u8;103]=[0x09,0x19,0x29,0x39,0x80,0x81,0x82,0x83,0x84,0x85,0x87,0x86,0xC6,0xE8,0x88,0x89,0x8A,0x8B,0x8C,0x8D,0x8F,0xCE,0x8E,0x90,0x91,
    0x92,0x93,0x94,0x95,0x97,0x96,0xD6,0x99,0x9A,0x9B,0x9C,0x9D,0x9F,0x9E,0xDE,0xA0,0xA1,0xA2,0xA3,0xA4,0xA5,0xA7,0xA6,0xE6,0xA8,
    0xA9,0xAA,0xAB,0xAC,0xAD,0xAF,0xAE,0xEE,0xB0,0xB1,0xB2,0xB3,0xB4,0xB5,0xB7,0xB6,0xF6,0xB8,0xB9,0xBA,0xBB,0xBC,0xBD,0xBF,0xBE,
    0xFE,0x03,0x13,0x23,0x33,0x04,0x0C,0x14,0x1C,0x24,0x2C,0x3C,0x34,0x0B,0x1B,0x2B,0x3B,0x05,0x0D,0x15,0x1D,0x25,0x2D,0x3D,0x35,0x27,0x2F,0xF8];

    fn is_arithmetic_logic_instruction(looking_opcode:u8) -> bool {
        let result = ARITHMETIC_LOGIC_OPCODES.iter().position(|&element| looking_opcode == element);
